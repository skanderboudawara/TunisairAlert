...
def get_text_dimensions(text_string: str, font):
    ...
    Args:
        text_string (str): the text string that will be outputed
...
def paste_plots(reportImg, x, y, plot_pic: str):
    ...
    Returns:
        _type_: the image with the plot picture generated by matplotlibs pasted
    """
...
def paste_kpi(
    ...
    Args:
        ...
        query_date_formatted (_type_): query date formated DD/MM/YYYY
...
def past_worse_flight(report, max_arrival_delay, h_start, query_date_formatted: str):
    ...
    Args:
        report (_type_): the report from PILLOW
        max_arrival_delay (_type_): the max querried arrival delay
        h_start (_type_):  global y pos
        query_date_formatted (str): query date formated DD/MM/YYYY
...
def past_titles(report, datetime_query):
    ...
    Args:
        report (_type_): the report from PILLOW
        datetime_query (_type_): query date formated DD/MM/YYYY
    """
    # Last update hour
    report.text(
        (55, 60),
