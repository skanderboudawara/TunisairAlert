...
flight_table_columns = ("ID_FLIGHT", "FLIGHT_NUMBER", "FLIGHT_STATUS", "DEPARTURE_IATA", "DEPARTURE_AIRPORT",
                        "ARRIVAL_IATA", "ARRIVAL_AIRPORT",  "DEPARTURE_SCHEDULED",
                        "ARRIVAL_SCHEDULED", "DEPARTURE_ESTIMATED", "ARRIVAL_ESTIMATED", "DEPARTURE_ACTUAL",
...
def create_table():
    ...
    '''
    conn = sqlite3.connect('tunisair_delay.db')
    cursor = conn.cursor()
